...
// Play game (no mode selection, just play all)
app.get("/", async (c) => {
  ...
  return c.html(gameLayout("Subjunctive Tense", `
...
app.post("/answer", async (c) => {
  ...
  return c.html(gameLayout("Subjunctive Tense", `
    <div class="feedback ${correct ? "correct" : "incorrect"}">
      ...
      <div class="actions">
        <a href="/french/subjunctive?index=${index + 1}" class="btn btn-primary">Next Question →</a>
      </div>
    </div>
  `, user));
});
